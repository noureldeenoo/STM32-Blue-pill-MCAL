...
void M_DIO_Void_TogPin( u8 Copy_u8Port , u8 Copy_u8Pin )
{
	switch(Copy_u8Port)
	{
...
void MGPIO_voidSetInputPull(u8 Copy_u8Port , u8 Copy_u8Pin , u8 u8Copy_u8Mode)
{
	switch( u8Copy_u8Mode )
	{
	case UP   :  MGPIO_VidSetPinValue( Copy_u8Port , Copy_u8Pin , HIGH );  break;
	case DOWN :  MGPIO_VidSetPinValue( Copy_u8Port , Copy_u8Pin , LOW  );  break;
	default   :                                                           break;
	}
